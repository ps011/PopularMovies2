...
import tk.prasheelsoni.popularmovies2.utils.SelectionBuilder;

import java.util.Arrays;

import timber.log.Timber;

import static tk.prasheelsoni.popularmovies2.data.provider.MoviesContract.CONTENT_AUTHORITY;
import static tk.prasheelsoni.popularmovies2.data.provider.MoviesContract.Genres;
import static tk.prasheelsoni.popularmovies2.data.provider.MoviesContract.Movies;
import static tk.prasheelsoni.popularmovies2.data.provider.MoviesDatabase.MoviesGenres;
import static tk.prasheelsoni.popularmovies2.data.provider.MoviesDatabase.Tables;
