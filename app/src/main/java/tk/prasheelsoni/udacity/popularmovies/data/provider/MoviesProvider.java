...
package tk.prasheelsoni.udacity.popularmovies.data.provider;
...
import tk.prasheelsoni.udacity.popularmovies.utils.SelectionBuilder;

import java.util.Arrays;

import timber.log.Timber;

import static tk.prasheelsoni.udacity.popularmovies.data.provider.MoviesContract.CONTENT_AUTHORITY;
import static tk.prasheelsoni.udacity.popularmovies.data.provider.MoviesContract.Genres;
import static tk.prasheelsoni.udacity.popularmovies.data.provider.MoviesContract.Movies;
import static tk.prasheelsoni.udacity.popularmovies.data.provider.MoviesDatabase.MoviesGenres;
import static tk.prasheelsoni.udacity.popularmovies.data.provider.MoviesDatabase.Tables;
